  ...
  wrappers.wrappers.niri.wrap {
    ...
    settings = {
      ...
      binds = {
        ...
        "Mod+Shift+Return" = {
          _attrs = {hotkey-overlay-title = "Open a File Manager";};
          spawn = ["thunar"];
        };

        "Mod+R" = {
          _attrs = {hotkey-overlay-title = "Run an Application: ags";};
          spawn = ["ags" "toggle" "launcher"];
        };

        "Mod+P" = {
          _attrs = {hotkey-overlay-title = "Run an Command: bemenu";};
          spawn = ["bemenu-run"];
        };

        "Mod+B" = {
          _attrs = {hotkey-overlay-title = "Open Browser";};
          spawn = ["brave"];
        };
        "Mod+Q" = {
          _attrs = {hotkey-overlay-title = "Restart ags";};
          spawn = ["systemctl" "--user" "restart" "ags.service"];
        };
        ...
        "Ctrl+Space".spawn = ["ags" "request" "clearLastNotification"];
        "Ctrl+Shift+Space".spawn = ["ags" "request" "clearAllNotifications"];
        ...
        "Mod+Shift+Q".quit._attrs.skip-confirmation = true;
